...
<h2><c:out value="${ jobStatusLabel }"></c:out> Jobs by Request</h2>

<html:form action="listRequests">
...
--%>
   ...
   <c:choose>
     <c:when test="${ ! empty jobTypes }">
	  ...
	  Job Type(Any of the jobs for the request have this job type):
...
<table  cellpadding="10" cellspacing="0" style="width:960px;" align="left">
 ...
 <c:forEach var="request" items="${ requestList }" varStatus="requestListVarStatus" >


  <tr >

   <td>Request ID: <c:out value="${ request.id } " /></td>
  </tr>


 <c:forEach var="job" items="${ request.jobList }" varStatus="jobListVarStatus" >
