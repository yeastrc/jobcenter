...
public class ServletContextAppListener extends HttpServlet implements
	...
	public void contextInitialized(ServletContextEvent event) {
		...
		log.info( "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!  Startup of Job Manager application, in Context Listener 'ServletContextAppListener'. !!!!!!!!!!!!!!!!!!!!!!!!" );

		log.error( "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!  Startup of Job Manager application, in Context Listener 'ServletContextAppListener'. !!!!!!!!!!!!!!!!!!!!!!!!" );
