...
public class ListJobsForm extends ActionForm {
	...
	private static Logger log = Logger.getLogger(ListJobsForm.class);
...
//     * @param value
//     */
//    public void setStatuses(int index, boolean value) {
//
//    	if ( index < MAX_STATUS_VALUES ) {
//    		
//    		statuses[ index ] = value;
//    		
//    	} else {
//    		
//    		log.error( "Set status index value exceeds MAX_STATUS_VALUES.  index = " + index + ", MAX_STATUS_VALUES = " + MAX_STATUS_VALUES );
//    	}
//    	
//    }
