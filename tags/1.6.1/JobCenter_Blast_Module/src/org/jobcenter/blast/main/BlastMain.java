...
public class BlastMain implements ModuleInterfaceClientMainInterface {
	...
	/* (non-Javadoc)
	 * @see org.jobcenter.job_client_module_interface.ModuleInterfaceClientMainInterface#destroy()
	 */
	@Override
	public void destroy() {
	...
	/* (non-Javadoc)
	 * @see org.jobcenter.job_client_module_interface.ModuleInterfaceClientMainInterface#processRequest()
	 */
	@Override
	public void processRequest( ModuleInterfaceRequest moduleInterfaceRequest, ModuleInterfaceResponse moduleInterfaceResponse, ModuleInterfaceJobProgress moduleInterfaceJobProgress, ModuleInterfaceClientServices moduleInterfaceClientServices ) throws Throwable {
		...
		Map<String, String> parameters = moduleInterfaceRequest.getJobParameters();
		...
		if (query == null || query == ""){
			...
			moduleInterfaceResponse.addRunMessage(RunMessageTypesConstants.RUN_MESSAGE_TYPE_ERROR, "Query string was not provided.");
			nullParamFound = true;
		}

		if (task == null || task == ""){
			jobStatus = JobStatusValuesConstants.JOB_STATUS_HARD_ERROR;
			moduleInterfaceResponse.addRunMessage(RunMessageTypesConstants.RUN_MESSAGE_TYPE_ERROR, "Blast task was not provided.");
			nullParamFound = true;
		}

		if (database == null || database == ""){
			jobStatus = JobStatusValuesConstants.JOB_STATUS_HARD_ERROR;
			moduleInterfaceResponse.addRunMessage(RunMessageTypesConstants.RUN_MESSAGE_TYPE_ERROR, "Database was not provided.");
			nullParamFound = true;
		}

		if (outfmt == null || outfmt == ""){
			jobStatus = JobStatusValuesConstants.JOB_STATUS_HARD_ERROR;
			moduleInterfaceResponse.addRunMessage(RunMessageTypesConstants.RUN_MESSAGE_TYPE_ERROR, "outfmt was not provided.");
			nullParamFound = true;
		}

		if (alignments == null || alignments == ""){
			jobStatus = JobStatusValuesConstants.JOB_STATUS_HARD_ERROR;
			moduleInterfaceResponse.addRunMessage(RunMessageTypesConstants.RUN_MESSAGE_TYPE_ERROR, "alignments number was not provided.");
			nullParamFound = true;
		}

		if (descriptions == null || descriptions == ""){
			jobStatus = JobStatusValuesConstants.JOB_STATUS_HARD_ERROR;
			moduleInterfaceResponse.addRunMessage(RunMessageTypesConstants.RUN_MESSAGE_TYPE_ERROR, "descriptions number was not provided.");
			nullParamFound = true;
		}

		if (email == null || email == ""){
			jobStatus = JobStatusValuesConstants.JOB_STATUS_HARD_ERROR;
			moduleInterfaceResponse.addRunMessage(RunMessageTypesConstants.RUN_MESSAGE_TYPE_ERROR, "email address was not provided.");
			nullParamFound = true;
		}

		if ((filename == null || filename == "") && (email == null || email == "")){
			jobStatus = JobStatusValuesConstants.JOB_STATUS_HARD_ERROR;
			moduleInterfaceResponse.addRunMessage(RunMessageTypesConstants.RUN_MESSAGE_TYPE_ERROR, "emial or filename was not provided.");
			nullParamFound = true;
		}
		...
		try {
			...
			moduleInterfaceResponse.addRunMessage( RunMessageTypesConstants.RUN_MESSAGE_TYPE_MSG, "Successful Completion Blast Main" );
	...
	/* (non-Javadoc)
	 * @see org.jobcenter.job_client_module_interface.ModuleInterfaceClientMainInterface#reset()
	 */
	@Override
